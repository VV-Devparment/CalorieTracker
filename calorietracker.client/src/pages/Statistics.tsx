    ...
    return (
        <div className="min-h-screen pb-24">
            <div className="max-w-md mx-auto px-4 py-5">
                ...
                <div className="card-rich p-5 mb-4 animate-fade-in-up">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-11 h-11 rounded-2xl bg-brand-gradient flex items-center justify-center shadow-pop">
                            <Icon name="chart" size={22} color="white" />
                        </div>
                        <div>
                            <h1 className="text-lg font-extrabold text-gray-900 leading-tight">Статистика</h1>
                            <p className="text-xs text-gray-500">Твої тренди харчування</p>
                        </div>
                    </div>
                    <div className="flex gap-1.5 bg-cream-100 p-1 rounded-2xl">
                        {periods.map((period) => (
                            <button
                                key={period.value}
                ...
                {loading ? (
                    ...
                    <>
                        {/* Summary Cards — colorful gradient tiles */}
                        <div className="mb-4 animate-fade-in-up">
                            <h2 className="text-sm font-bold text-gray-700 uppercase tracking-wider px-1 mb-2 flex items-center gap-2">
                                <span className="inline-block w-1 h-4 rounded-full bg-brand-gradient" />
                                Середні показники
                            </h2>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="tile-kcal">
                                    <div className="relative z-10">
                                        <Icon name="calories" size={24} color="white" />
                                        <div className="text-[10px] uppercase tracking-wider text-white/85 font-bold mt-2">Калорії/день</div>
                                        <div className="text-2xl font-extrabold leading-none mt-1">
                                            {Math.round(userStats.averageCalories)}
                                        </div>
                                        <div className="text-[10px] text-white/75 mt-1">ціль: {calorieGoal}</div>
                                    </div>
                                </div>
                                <div className="tile-protein">
                                    <div className="relative z-10">
                                        <Icon name="protein" size={24} color="white" />
                                        <div className="text-[10px] uppercase tracking-wider text-white/85 font-bold mt-2">Білки/день</div>
                                        <div className="text-2xl font-extrabold leading-none mt-1">
                                            {Math.round(userStats.averageProtein)}<span className="text-sm font-semibold text-white/85 ml-0.5">г</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="tile-fats">
                                    <div className="relative z-10">
                                        <Icon name="fats" size={24} color="white" />
                                        <div className="text-[10px] uppercase tracking-wider text-white/85 font-bold mt-2">Жири/день</div>
                                        <div className="text-2xl font-extrabold leading-none mt-1">
                                            {Math.round(userStats.averageFats)}<span className="text-sm font-semibold text-white/85 ml-0.5">г</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="tile-carbs">
                                    <div className="relative z-10">
                                        <Icon name="carbs" size={24} color="white" />
                                        <div className="text-[10px] uppercase tracking-wider text-white/85 font-bold mt-2">Вуглеводи/день</div>
                                        <div className="text-2xl font-extrabold leading-none mt-1">
                                            {Math.round(userStats.averageCarbs)}<span className="text-sm font-semibold text-white/85 ml-0.5">г</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {calorieChartData.length > 0 && (
                            <div className="card-rich p-5 mb-4">
                        ...
                        <div className="card-rich p-5 mb-4">
                            <h2 className="text-lg font-extrabold text-gray-900 mb-4 flex items-center gap-2">
                                <span className="inline-block w-1 h-5 rounded-full bg-brand-gradient" />
                                Активність
                            </h2>
                            <div className="space-y-2.5">
                                <div className="flex items-center justify-between p-3.5 bg-gradient-to-br from-purple-50 to-purple-100/40 rounded-2xl border border-purple-200/60">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-400 to-violet-600 flex items-center justify-center shadow-md">
                                            <Icon name="calendar" size={20} color="white" />
                                        </div>
                                        <div>
                                            <p className="font-bold text-gray-900 text-sm">Активні дні</p>
                                            <p className="text-xs text-gray-500">Днів з записами</p>
                                        </div>
                                    </div>
                                    <span className="text-2xl font-extrabold bg-gradient-to-br from-purple-500 to-violet-700 bg-clip-text text-transparent">{userStats.daysWithData}</span>
                                </div>
                                <div className="flex items-center justify-between p-3.5 bg-gradient-to-br from-brand-50 to-brand-100/40 rounded-2xl border border-brand-200/60">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-brand-gradient flex items-center justify-center shadow-md">
                                            <Icon name="plate" size={20} color="white" />
                                        </div>
                                        <div>
                                            <p className="font-bold text-gray-900 text-sm">Всього прийомів</p>
                                            <p className="text-xs text-gray-500">За обраний період</p>
                                        </div>
                                    </div>
                                    <span className="text-2xl font-extrabold text-gradient-brand">{userStats.totalMeals}</span>
                                </div>
                                <div className="flex items-center justify-between p-3.5 bg-gradient-to-br from-fresh-50 to-fresh-100/40 rounded-2xl border border-fresh-300/60">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-fresh-gradient flex items-center justify-center shadow-md">
                                            <Icon name="average" size={20} color="white" />
                                        </div>
                                        <div>
                                            <p className="font-bold text-gray-900 text-sm">Середньо/день</p>
                                            <p className="text-xs text-gray-500">Регулярність</p>
                                        </div>
                                    </div>
                                    <span className="text-2xl font-extrabold text-gradient-fresh">
                    ...
                    <div className="card-rich p-8 text-center">
